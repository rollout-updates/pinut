            ...
            if ((Test-Path -LiteralPath $downloadedFile -PathType Leaf)) {
                ...
                if ($fileInfo.Length -gt 0) {
                    ...
                    if ($actualHash -eq $expectedHash) {
                        ...
                        # Re-salva o arquivo com assinatura UTF-8 (BOM) para evitar erros de parser no PowerShell 5.1 do Windows
                        $content = [System.IO.File]::ReadAllText($downloadedFile, [System.Text.Encoding]::UTF8)
                        [System.IO.File]::WriteAllText($downloadedFile, $content, [System.Text.Encoding]::UTF8)
